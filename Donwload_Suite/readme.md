...
ENSURE YOU MAKE SURE THERE IS ONLY ONE SSID THAT MATCHES, ROUTERS CAN HAVE 2.4GHz and 5GHz NETWORKS WITH THE SAME SSID, BUT DIFFERENT BSSIDS, IF THERE ARE TWO, OPEN ANOTHER TERMINAL AND FOLLOW THE STEP YOU ARE ON TWICE AND FOR BOTH SIDES
$\color{Apricot}{!! WARNING !!\}$
```
./BroadSurvey.sh
```
